...
registerOnClick('firma', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam10', 'firma', 1, function() {}, 0);
}, function(event) {});

registerOnClick('minovia', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam8', 'minovia', 1, function() {}, 0);
}, function(event) {});

registerOnClick('serpiente', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam5', 'serpiente', 1, function() {}, 0);
}, function(event) {});

registerOnClick('minovia2', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam6', 'minovia2', 1, function() {}, 0);
}, function(event) {});

registerOnClick('angel', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam9', 'angel', 1, function() {}, 0);
}, function(event) {});

registerOnClick('dreamer', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam2', 'dreamer', 1, function() {}, 0);
}, function(event) {});

registerOnClick('moustro', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam7', 'moustro', 1, function() {}, 0);
}, function(event) {});

registerOnClick('z', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam4', 'z', 1, function() {}, 0);
}, function(event) {});

registerOnClick('so so', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam3', 'so so', 1, function() {}, 0);
}, function(event) {});
